    ...
    with torch.no_grad():
        ...
        for i, batch in enumerate(dataloader):
            ...
            for _ in range(g_mel.size(0)):
                ...
                estoi_list.append(
                    stoi(
                        wav_tr[_][:min_len], wav_pred[_][:min_len], 16000, extended=True
                    )
                )
                try:
                    pesq_list.append(
                ...
                np.savez(
                    f"./test_{args.data_name}/mel/{m_name}/{v_name}/{file_name}.npz",
                ...
                sf.write(
                    f"./test_{args.data_name}/wav/{m_name}/{v_name}/{file_name}.wav",
                    wav_pred[_],
                    16000,
                    subtype="PCM_16",
                )
